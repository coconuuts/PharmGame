...
public class TimeService {
    ...
    readonly ObservableDayNight<bool> isDayTime;
    readonly ObservableDayNight<int> currentHour;
    ...
    public TimeService(TimeSettings settings) {
        ...
        isDayTime = new ObservableDayNight<bool>(IsDayTime());
        currentHour = new ObservableDayNight<int>(currentTime.Hour);

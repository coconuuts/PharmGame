// --- START OF FILE BasicBrowseStateSO.cs ---
...
{
    [CreateAssetMenu(fileName = "BasicBrowseState", menuName = "NPC/Basic States/Basic Browse", order = 4)] // Order according to customer flow
    public class BasicBrowseStateSO : BasicNpcStateSO
    {
        public override System.Enum HandledBasicState => BasicState.BasicBrowse;
        ...
        // You could override these fields here if you wanted a specific timeout for browsing.
        ...
        public override void OnEnter(TiNpcData data, BasicNpcStateManager manager)
        {
            ...
            // Additional setup specific to browse simulation if needed (likely none for now)
             Debug.Log($"SIM {data.Id}: BasicBrowseState OnEnter. Will remain frozen until timeout ({data.simulatedStateTimer:F2}s initial).");
        }
...
// --- END OF FILE BasicBrowseStateSO.cs ---
// --- START OF FILE NpcDecisionHelper.cs (Modified) ---

// --- START OF FILE NpcDecisionHelper.cs --- // Keep original comment for history
...
namespace Game.NPC.Decisions // Place in the same namespace as DecisionPointSO and DecisionOption
{
    ...
    /// MODIFIED: Returns PathTransitionDetails struct.
    /// </summary>
    public static class NpcDecisionHelper // Static class, no inheritance needed
    {
        ...
        public static PathTransitionDetails MakeDecision(TiNpcData tiData, DecisionPointSO decisionPoint, TiNpcManager tiManager) // <-- MODIFIED Return Type
        {
            if (tiData == null)
            {
            ...
            // 5. Return the chosen option's transition details
...
// --- END OF FILE NpcDecisionHelper.cs (Modified) ---